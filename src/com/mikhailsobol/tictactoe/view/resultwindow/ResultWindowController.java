...
public class ResultWindowController implements Initializable {
    ...
    public void initialize(final URL url,
        ...
        final String result =
                winner == null ? DEFAULT_DRAW_TEXT : DEFAULT_WINNER_TEXT + winner.getName();
        resultLabel.setText(result);
    }

    @FXML
    private void mainMenuButtonOnAction(final ActionEvent event) throws IOException {
        Parent settingSceneParent = FXMLLoader.load(getClass().getClassLoader().getResource("com/mikhailsobol/tictactoe/view/mainmenuwindow/MainMenuWindow.fxml"));
