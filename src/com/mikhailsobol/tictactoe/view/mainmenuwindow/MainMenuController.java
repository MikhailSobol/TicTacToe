...
public class MainMenuController implements Initializable {
    ...
    private void goToGameWindow(final ActionEvent event) throws Exception {
        Parent settingSceneParent = FXMLLoader.load(getClass().getClassLoader().getResource("com/mikhailsobol/tictactoe/view/gamewindow/GameWindow.fxml"));
    ...
    private boolean checkAi() {
        return aiDifficultyLevelChoiceBox.getValue() instanceof DifficultyLevel;
    }

    private IAi getAi() {
        return aiDifficultyLevelChoiceBox.getValue().equals(DifficultyLevel.EASY) ? new EasyAi() : new HardAi();
    }
